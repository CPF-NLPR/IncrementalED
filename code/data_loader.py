...
class Load:
    ...
    def load_full_labels(self):
        id2label = {}
        label2id = {}
        labels = ['None', 'Justice.Trial-Hearing', 'Life.Die', 'Transaction.Transfer-Money',
                  'Life.Injure', 'Personnel.End-Position', 'Personnel.Elect', 'Contact.Meet',
                  'Contact.Phone-Write', 'Movement.Transport', 'Conflict.Attack']
        for label in labels:
